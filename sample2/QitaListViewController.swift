...
class QitaListViewController: UIViewController,HMTableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        qiitaListView.table.hmDelegate   = self;
        qiitaListView.table.hmDataSource = mModel;
    ...
    func tableView(tableView: HMTableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
